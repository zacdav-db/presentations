...
* [Creat a Databricks Free Edition account](https://login.databricks.com/signup?provider=DB_FREE_TIER)
* [Databricks Generative AI MCP Overview](https://docs.databricks.com/en/generative-ai/mcp/)  
* [Custom MCP Server Template](https://marketplace.databricks.com/details/e109cf23-ee53-46ce-92d7-8a562138c62c/Databricks_Custom-MCP-Server-Template)  
* [Databricks MCP Custom Server Examples](https://github.com/databrickslabs/mcp/tree/master/examples/custom-server)
